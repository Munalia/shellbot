...
async def start(c, m):
    ...
    await c.send_message(chat_id=m.chat.id,
                         ...
                         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("My Owner 👨‍💻", url='https://t.me/KSsupport_Bot'), InlineKeyboardButton("📌Movies Searcher", url='https://t.me/KS_MoviesSearcherBot')]]))
